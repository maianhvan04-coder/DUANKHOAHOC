...
const ADMIN_PERMISSION_ROUTES: Array<{
  ...
  { href: "/admin/course/categories", prefixes: ["category:"] },
  {
    href: "/admin/course",
    prefixes: ["course:", "enrollment:"],
  },
  { href: "/admin/blog/categories", prefixes: ["blog_category:"] },
  { href: "/admin/blog", prefixes: ["blog:"] },
  ...
  { href: "/admin/balance-history", prefixes: ["balance_history:"] },
  { href: "/admin/bank-history", prefixes: ["bank_history:"] },
